  ...
  return (
    <main style={styles.page}>
      <section style={styles.card}>
        <div style={styles.badge}>NEW LOGIN PAGE ACTIVE</div>
...
const styles = {
  ...
  badge: { display: 'inline-block', background: '#dcfce7', color: '#166534', padding: '7px 12px', borderRadius: 999, fontWeight: 800, fontSize: 13, marginBottom: 14 },
